    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Citrus Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Citrus address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and citrus: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Citrus Core"), this);
    aboutAction->setStatusTip(tr("Show information about Citrus Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Citrus Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Citrus addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Citrus addresses"));
    ...
    openAction->setStatusTip(tr("Open a citrus: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Citrus Core help message to get a list with possible Citrus Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Citrus Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Citrus network", "", count));
    } else {
...
{
    QString strTitle = tr("Citrus Core"); // default title
