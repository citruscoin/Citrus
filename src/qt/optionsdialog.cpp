    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("CITR-light"), QVariant("light"));
    ui->theme->addItem(QString("CITR-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("CITR-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("CITR-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("CITR-traditional"), QVariant("trad"));
