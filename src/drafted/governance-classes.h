 ...
 *
 *   // network
 *   CCitrusNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.citrus.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CCitrusNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: CitrusNetwork
// //   -- signature requirements : Key1(User)
// class CCitrusNetworkVariable : public CGovernanceObject
// {
// private:
