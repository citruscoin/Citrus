...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "CitrusNetwork") type = CitrusNetwork;
    if(strType == "CitrusNetworkVariable") type = CitrusNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == CitrusNetwork) s = "CitrusNetwork";
    if(type == CitrusNetworkVariable) s = "CitrusNetworkVariable";
