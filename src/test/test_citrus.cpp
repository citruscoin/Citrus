...
#define BOOST_TEST_MODULE Citrus Test Suite

#include "test_citrus.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_citrus_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
