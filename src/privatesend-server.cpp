...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Citrus related functionality
...
/*
    ...
    allow endless transaction that would bloat Citrus and make it unusable. To
