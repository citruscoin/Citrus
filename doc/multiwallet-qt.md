...
Only requiring some minor changes is citrus.cpp.
...
Changes to citrus.cpp
----------------------
citrus.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
