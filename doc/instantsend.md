...
This mechanism has been integrated into Bitcore-Node-Citrus which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/citruspay/insight-api-citrus#web-socket-api](https://github.com/citruspay/insight-api-citrus#web-socket-api)
* API: [https://github.com/citruspay/insight-api-citrus#instantsend-transactions](https://github.com/citruspay/insight-api-citrus#instantsend-transactions)
...
By default, the Citrus Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Citrus Core daemon:
